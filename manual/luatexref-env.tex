...
\def\TitlePage#1{%
\startstandardmakeup % \startTEXpage
...
\stopstandardmakeup % \stopTEXpage
}
...
\catcodetable\syntaxcodetable
!def!dostartsyntax#1\stopsyntax{!let<!nonterminal!syntaxenvbody{#1}!endgroup}
!def!dosyntax#1{!let<!nonterminal!syntaxbody{#1}!endgroup}
!catcodetable!texcatcodes
