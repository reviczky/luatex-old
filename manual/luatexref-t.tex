...
\NC left_boundary      \NC no       \NC yes      \NC yes \NC number \NC left boundary glyph (default: none)\NC \NR
...
The \type{fonts} is another Lua array. The values are two-value hashes
...
at a little over 9pt. The array index numbers are used by the
